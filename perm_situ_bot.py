            ...
            example_data = {
                "questions": [
                    ...
                    },
                    {
                        ...
                        "answer": "К обучению допускаются жители Пермского края, имеющие диплом СПО, ВО или являющиеся студентами вузов и колледжей региона. После выбора курса нужно заполнить анкету и пройти входное тестирование. При успешном прохождении теста слушатель зачисляется на программу."
                    },
                    {
                        "id": "q5",
                    ...
                    },
                    {
                        ...
                        "answer": "Перечень всех программ размещён на Яндекс.Диске: https://disk.yandex.ru/d/O85bF-aEdHqbdQ (файл СИТУ_План_на_2025_год_для_публикации_.xlsx)."
                    },
                    {
                        "id": "q7",
                    ...
                    },
                    {
                        ...
                        "answer": "Результаты входного контроля публикуются не позднее чем за 2 рабочих дня до начала занятий по выбранной программе."
                    },
                    {
                        "id": "q12",
                        "question": "Какой документ получу после обучения?",
