...
class SITUBot:
    ...
    def create_main_keyboard(self) -> Dict:
        ...
        3. Кнопки "Остались вопросы?" и "Завершить диалог"
        """
        buttons = []
        ...
        # Добавляем кнопку "Перейти в чат с куратором СИТУ"
        buttons.append([{
            'type': 'callback',
    ...
    def handle_callback(self, callback_id: str, payload: str, chat_id: int):
        ...
        # Специальная обработка для кнопки "Перейти в чат с куратором СИТУ"
